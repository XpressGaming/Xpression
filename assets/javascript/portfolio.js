...
$(document).ready(() => {
  const links = [
    {
      name: 'Xpression#1337',
      link: 'https://discord.com/users/710537186810003466',
    },
    {
      name: 'Sellix - Shop',
      link: 'https://sellix.io/Xpression-Cards',
    },
    {
      name: 'Twitch',
      link: 'https://www.twitch.tv/myxpression',
    },
    {
      name: 'Twitter',
      link: 'https://twitter.com/Xpression18',
    },
  ];
  ...
  app.titleChanger(['$myxpression', '#xpression-cards', '#140K', '#on twitch', 'Kylof Söze - WitaPoke']);
